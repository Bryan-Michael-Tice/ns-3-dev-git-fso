...
int main (int argc, char** argv)
{
  ...
  //MDP - 
  Ptr<FsoChannel> fsoChannel = Createobject<FsoSingleModelSpectrumChannel> ();
  Ptr<FsoPropagationLossModel> fsoPropLoss = Createobject<FsoPropagationLossModel> ();
  Ptr<PropagationDelayyModel> delayModel = Createobject<ConstantSpeedPropagationDelayModel> ();
