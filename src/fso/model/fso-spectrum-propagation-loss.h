...
#ifndef FSO_SPECTRUM_PROPAGATION_LOSS_H
#define FSO_SPECTRUM_PROPAGATION_LOSS_H
 ...
 */
class FsoSpectrumPropagationLossModel : public SpectrumPropagationLossModel
{

public:
  FsoSpectrumPropagationLossModel ();
  ~FsoSpectrumPropagationLossModel ();
